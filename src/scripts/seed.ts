...
async function _seed(dataSource: DataSource): Promise<void> {
  ...
  const users = await userRepo.save([
    ...
    },
    {
      ...
      workExperience: [{ id: 'we-3', title: 'Backend Developer', years: 3 }],
    },
    {
      name: 'Charlie Brown',
    ...
    },
    {
      ...
      workExperience: [{ id: 'we-6', title: 'Data Engineer', years: 4 }],
    },
    {
      name: 'Eve Wilson',
  ...
  const task1 = await taskRepo.save(
    taskRepo.create({
      ...
      description:
        'Clone the repo, install dependencies, configure .env, and verify the dev server starts.',
      estimatedDays: 0.5,
      isCompleted: true,
  ...
  await taskRepo.save([
    taskRepo.create({
      ...
      description:
        'Run git clone and npm install, ensuring all packages resolve without errors.',
      estimatedDays: 0.25,
      isCompleted: true,
    ...
    taskRepo.create({
      ...
      description:
        'Copy .env.example to .env, fill in local values, then run npm run dev and confirm the app loads.',
      estimatedDays: 0.25,
      isCompleted: true,
      links: [],
      onboarding: sampleOnboarding,
  ...
  const task2 = await taskRepo.save(
    taskRepo.create({
      ...
      description:
        'Read through the module structure — controllers, services, repositories — and trace a full request.',
      estimatedDays: 1,
      isCompleted: true,
      links: [],
      onboarding: sampleOnboarding,
  ...
  await taskRepo.save([
    taskRepo.create({
      ...
      description:
        'Go through each module folder and understand the controller → service → repository pattern.',
      estimatedDays: 0.5,
      isCompleted: true,
      links: [],
      onboarding: sampleOnboarding,
    ...
    taskRepo.create({
      ...
      description:
        'Pick one existing feature and follow the request from route → controller → service → DB and back.',
      estimatedDays: 0.5,
      isCompleted: true,
      links: [],
      onboarding: sampleOnboarding,
  ...
  const task3 = await taskRepo.save(
    taskRepo.create({
      ...
      description:
        'Build the React component using TypeScript, fetch data from the API, and handle loading/error states.',
      estimatedDays: 2,
      isCompleted: false,
      links: [
  ...
  await taskRepo.save([
    taskRepo.create({
      ...
      description:
        'Sketch the component tree, decide which state lives locally vs. in a query hook.',
      estimatedDays: 0.5,
      isCompleted: false,
      links: [],
      onboarding: sampleOnboarding,
    ...
    taskRepo.create({
      ...
      description:
        'Implement the JSX layout, type all props, and apply Tailwind classes matching the design.',
      estimatedDays: 1,
      isCompleted: false,
      links: [
        'https://react.dev/reference/react',
    ...
    taskRepo.create({
      ...
      description:
        'Wire up the React Query hook, show a skeleton loader while fetching, and render an error message on failure.',
      estimatedDays: 0.5,
      isCompleted: false,
      links: [
  ...
  const task4 = await taskRepo.save(
    taskRepo.create({
      ...
      description:
        'Add Jest + React Testing Library tests covering render, empty state, and data-loaded states.',
      estimatedDays: 0.5,
      isCompleted: false,
  ...
  await taskRepo.save([
    taskRepo.create({
      ...
      description:
        'Assert the component mounts without crashing and matches its snapshot.',
      estimatedDays: 0.25,
      isCompleted: false,
    ...
    taskRepo.create({
      ...
      description:
        'Mock the API response, render with data, and assert list items appear; repeat for the empty state.',
      estimatedDays: 0.25,
      isCompleted: false,
  ...
  const task5 = await taskRepo.save(
    taskRepo.create({
      ...
      description:
        'Open a PR, self-review, address reviewer comments, and get approval before merging.',
      estimatedDays: 1,
      isCompleted: false,
  ...
  await taskRepo.save([
    taskRepo.create({
      ...
      description:
        'Run the linter, fix all warnings, and re-read your diff to catch obvious mistakes.',
      estimatedDays: 0.5,
      isCompleted: false,
      links: [],
      onboarding: sampleOnboarding,
    ...
    taskRepo.create({
      ...
      description:
        'Respond to each review comment, push fixes, and request re-review until the PR is approved.',
      estimatedDays: 0.5,
      isCompleted: false,
      links: [],
      onboarding: sampleOnboarding,
