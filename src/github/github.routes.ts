...
router.post('/:id/github/:connectionId/sync', requireProjectAdmin, githubController.sync);
router.delete('/:id/github/:connectionId', requireProjectAdmin, githubController.disconnect);
